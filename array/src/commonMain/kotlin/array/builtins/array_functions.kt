...
abstract class ConcatenateAPLFunctionImpl(pos: FunctionInstantiation) : APLFunction(pos) {
    ...
    private fun loopedReduce(
        ...
        return super.reduce(context, arg, sizeAlongAxis, stepLength, offset, savedStack, functionAxis)

//        val axisInt = if (functionAxis == null) defaultAxis(a, b)
//        return super.reduce(context, arg, sizeAlongAxis, stepLength, offset, savedStack, null)
    }
